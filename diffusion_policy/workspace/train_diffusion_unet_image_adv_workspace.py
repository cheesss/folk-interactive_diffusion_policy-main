...
from diffusion_policy.policy.diffusion_unet_image_adv_policy import DiffusionUnetImageAdvPolicy
...
class TrainDiffusionUnetImageAdvWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: DiffusionUnetImageAdvPolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: DiffusionUnetImageAdvPolicy = None
