...
class _VRTrackerBridge(Node):
    def __init__(self, target_frame):
        ...
        self._mode_pub = self.create_publisher(UInt8, "/teleop_mode", 10)
                ...
                while True:
                    ...
                    while True:
                        ...
                        if mode == "policy":
                            ...
                            if hasattr(env, "exec_direct_actions"):
                                env.exec_direct_actions(actions=[action])
                            else:
                                env.exec_actions(
                                    actions=[action],
